...
2. Generate hypothesis on which borrower attributes contribute to probability of default     
...
```{r}
CART_tree_large<-rpart::rpart(formula, data=estimation_data_nolabel, method="class", control=rpart::rpart.control(cp=0.00001, maxdepth=6, minbucket = 10))
rpart.plot::rpart.plot(CART_tree)
```
